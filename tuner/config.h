...
constexpr tune_t initial_learning_rate = 0.04;
constexpr int32_t learning_rate_drop_interval = 300000;
constexpr tune_t learning_rate_drop_ratio = 0.50;
constexpr bool print_data_entries = false;
constexpr int32_t data_load_print_interval = 100000;

constexpr int32_t num_coefficients_to_preload = 6;
constexpr bool eval_from_side_to_move = true;
